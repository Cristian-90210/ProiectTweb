            ...
            <div className="container mx-auto px-6 mt-10 relative z-20 max-w-4xl space-y-6">
                ...
                >
                    <SettingsToggleItem
                        ...
                        description="Receive updates about your training groups via email"
                    ...
                    <SettingsToggleItem
                        ...
                        description="Get notified about new messages and events in real-time"
                    ...
                    <SettingsToggleItem
                        ...
                        description="Remind me before upcoming training sessions"
                    ...
                    <SettingsToggleItem
                        ...
                        description="Get notified when students miss sessions"
                ...
                >
                    <SettingsToggleItem
                        ...
                        description="Allow students and parents to view your profile"
