    ...
    return (
        <div className="h-screen bg-[#0f172a] text-gray-100 flex flex-col font-outfit overflow-hidden">
            <PageHeader
                ...
                subtitle="High-performance chat interface for coach-student coordination."
            />
                        ...
                        {isProfileOpen && (
                            <aside className="w-[360px] border-l border-white/5 flex flex-col bg-[#1e293b]/50 animate-in slide-in-from-right duration-500 min-h-0">
                                <div className="p-6 border-b border-white/5 flex items-center justify-between flex-shrink-0">
                                    <h3 className="font-extrabold text-sm uppercase tracking-widest text-gray-400">Info Elev</h3>
                                ...
                                <div className="flex-1 min-h-0 overflow-y-auto p-8 custom-scrollbar">
                                    <div className="text-center mb-10">
                                        ...
                                        <p className="text-host-cyan font-bold uppercase tracking-widest text-[11px] mb-8">Elev Înot</p>
                                        <div className="flex gap-2 justify-center">
                                            ...
                                            <button className="flex-1 bg-white/5 hover:bg-white/10 border border-white/5 p-4 rounded-3xl transition-all flex flex-col items-center gap-2"><Search size={20} className="text-gray-400" /><span className="text-[10px] font-bold uppercase text-gray-500">Search</span></button>
                                        </div>
                                    </div>
                                    <div>
